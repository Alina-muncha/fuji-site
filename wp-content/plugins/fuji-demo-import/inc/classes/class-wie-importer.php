...
class RWS_WIE_Importer
{
	 ...
	 * @since 0.3
	 */
	function rws_wie_upload_import_file($args) {

			$uploaded_file_name = $args['wie_file'];
			$uploaded_file = RWS_DEMO_CONTENT_PATH.$uploaded_file_name;
			$file = str_replace( '\\', '/', $uploaded_file );
			// Process import file.
			$this->rws_wie_process_import_file( $file);
	}
	 ...
	 */
	function rws_wie_process_import_file( $file ) {
		//print_r($file);
		...
		$wie_import_results = $this->rws_wie_import_data( $data );
	}
	 ...
	 */
	function rws_wie_import_data( $data ) {
		...
		$available_widgets = $this->rws_wie_available_widgets();
	 ...
	 */
	function rws_wie_available_widgets() {
...
function rws_wie_import( $args ) {

	$wieimport = new RWS_WIE_Importer();
	$wieimport->rws_wie_upload_import_file($args);
