 ...
 * @subpackage Importer
 */
if ( ! class_exists( 'RWS_XML_Importer' ) ) {
	class RWS_XML_Importer extends WP_Importer
	{
		...
		function __construct( $args ) {
			...
			$xml_upload_file = RWS_DEMO_CONTENT_PATH.$args['file'];
...
function rws_xml_import( $args ) {

	$defaults = array( 'file' => '', 'map_user_id' => 0);
	$args = wp_parse_args( $args, $defaults );
	$autoimport = new RWS_XML_Importer( $args );
