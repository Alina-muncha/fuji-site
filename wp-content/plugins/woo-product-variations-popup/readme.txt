...
Contributors: codiminds
Tags: WooCommerce, Products, Variations, Popup
...
This plugin provides functionality to select WooCommerce Product Variations in a popup. No need to go on the product detail page anymore.
 
== Description ==
 
This plugin provides a very easy way to select WooCommerce product variations in a popup. When you enable the plugin, it will let the user select product variations in a popup so the user does not have to go to product detail page to add the product to the cart.
