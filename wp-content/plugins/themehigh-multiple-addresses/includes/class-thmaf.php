    ...
    */
    class THMAF {
        ...
        public function plugin_action_links($links) {
            $premium_link = '<a href="https://www.themehigh.com/product/woocommerce-multiple-addresses-pro">'. __('Premium plugin') .'</a>';
            $settings_link = '<a href="'.admin_url('admin.php?&page=th_multiple_addresses_free').'">'. __('Settings') .'</a>';
