 ...
 * Description:       Themehigh Multiple Addresses plugin helps the shoppers to save multiple customer addresses to My Account page, and choose from one of them while placing the next order.
 * Version:           1.2.0
 * Author:            ThemeHigh
