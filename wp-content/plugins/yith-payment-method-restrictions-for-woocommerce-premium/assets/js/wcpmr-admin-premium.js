        ...
        yith_change           : function ( event, selector, type_restriction ) {
            ...
            switch ( type_restriction ) {
                ...
                case 'user':
                    row.find( '.yith-wcpmr-restriction-by' ).show();
                    row.find( '.yith-wcpmr-restriction-type' ).select2();
                    row.find( '.yith-wcpmr-select2-user' ).show();
                    row.find( '.yith-wcpmr-user-search' ).select2();
                    $( document.body ).trigger( 'wc-enhanced-select-init' );
                ...
                case 'subscription':
                    row.find( '.yith-wcpmr-restriction-by' ).show();
                    row.find( '.yith-wcpmr-restriction-type' ).select2();
                    row.find( '.yith-wcpmr-select2-subscription' ).show();
                    row.find( '.yith-wcpmr-subscription-search' ).css( 'display', 'inline' );
                    $( document.body ).trigger( 'wc-enhanced-select-init' );
                    break;
            }
        },
