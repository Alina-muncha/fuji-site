...
@package YITH Payment Method Restrictions for WooCommerce Premium
 */
...
if ( ! function_exists( 'yith_wcpmr_install_woocommerce_admin_notice' ) ) {
	...
	function yith_wcpmr_install_woocommerce_admin_notice() { ?>
		<div class="error">
			<p><?php echo esc_html_x( 'YITH Payment Method Restrictions is enabled but not effective. It requires WooCommerce in order to work.', 'Alert Message: WooCommerce requires', 'yith-payment-method-restrictions-for-woocommerce' ); ?></p>
		</div>
		<?php
	}
}
...
/* === DEFINE === */
! defined( 'YITH_WCPMR_VERSION' ) && define( 'YITH_WCPMR_VERSION', '1.1.19' );
...
! defined( 'YITH_WCPMR_OPTIONS_PATH' ) && define( 'YITH_WCPMR_OPTIONS_PATH', YITH_WCPMR_PATH . 'plugin-options' );
