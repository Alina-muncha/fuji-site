...
if ( !class_exists( 'YITH_Payment_Restrictions_Admin' ) ) {
    ...
    class YITH_Payment_Restrictions_Admin
    {
        ...
        /**
         * Return array of screen ids for payment method restrictions plugins
         *
        ...
        public function get_screen_ids() {
            ...
            $screen_ids = array(
                $base . '_page_yith_wcpmr_payment_restriction_panel',
                'yith-plugins_page_yith_wcpmr_payment_restriction_panel',
            );

            return apply_filters( 'yith_wcpmr_screen_ids', $screen_ids );
        }
    }
}