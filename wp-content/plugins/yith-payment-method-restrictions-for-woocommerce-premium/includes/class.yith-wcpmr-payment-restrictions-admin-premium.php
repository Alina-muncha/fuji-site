...
if ( !class_exists( 'YITH_Payment_Restrictions_Admin_Premium' ) ) {
    ...
    class YITH_Payment_Restrictions_Admin_Premium extends YITH_Payment_Restrictions_Admin
    {
        ...
        public function enqueue_scripts()
        {
            ...
            $scripts_screens = $this->get_screen_ids();
            
            if( in_array( $screen->id, $scripts_screens )  || ( isset($post) && 'yith_wcpmr_rule' == $post->post_type ) ) {
        ...
        public function action_links( $links ) {
            $links = yith_add_action_links( $links, $this->_panel_page, true, YITH_WCPMR_SLUG );
            return $links;
        }
