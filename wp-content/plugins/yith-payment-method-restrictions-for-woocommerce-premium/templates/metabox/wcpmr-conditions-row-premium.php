...
<div class="yith-wcpmr-conditions-row">
    <div class="yith-wcpmr-type-of-conditions">
        <div class="yith-wcpmr-restriction-by">
			...
			<div class="yith-wcpmr-select2 yith-wcpmr-select2-user yith-wcpmr-row">
				<?php
				...
				if (!empty($users_selected)) {
					...
					if ($users) {
						foreach ( $users as $user_id ) {
							...
							$data_selected[$user_id] = $user->data->display_name . ' (#' . $user_id . ' - ' . $user->data->user_email . ')';
						}
					}
				}

				$class = 'wc-customer-search yith-wcpmr-user-search yith-wcpmr-information yith-wcpmr-user yith-wcpmr-select yith-wcpmr yith-wcpmr-li';
				$class = isset( $users_selected ) ? $class.' yith-wcpmr-rule-set yith-wcpmr-selector2' : $class;

				$search_user_array = array(
					'type' => '',
					'class' => $class,
					'id' => 'yith_wcpmr_user_selector',
					'name' => 'yith-wcpmr-rule[conditions][' . $i . '][users_selected]',
					'data-placeholder' => esc_attr__('Search for a user&hellip;', 'yith-payment-method-restrictions-for-woocommerce'),
				...
				yit_add_select2_fields($search_user_array);
				?>
			</div>
