...
?>
    <div class="col-md-6 col-xxl-5 mx-auto my-5">
        <form method="post" class="woocommerce-ResetPassword lost_reset_password">
            ...
            <div class="mb-3">
                <label for="password_1" class="form-label fw-bold"><?php esc_html_e( 'New password', 'woocommerce' ); ?>
                    &nbsp;<span
                            class="required">*</span></label>
                <input type="password"
                       class="woocommerce-Input woocommerce-Input--text input-text form-control rounded-0"
                       name="password_1"
                       id="password_1" autocomplete="new-password"/>
            </div>
            <div class="mb-3">
                <label for="password_2"
                       class="form-label fw-bold"><?php esc_html_e( 'Re-enter new password', 'woocommerce' ); ?>
                    &nbsp;<span
                            class="required">*</span></label>
                <input type="password"
                       class="woocommerce-Input woocommerce-Input--text input-text form-control rounded-0"
